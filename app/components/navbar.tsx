    ...
    <header className="w-full h-[127.41px] flex justify-center items-center">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <div className=" h-[38px] rounded-[40px] pt-2 pr-3 pb-2 pl-3 gap-[12px] border border-solid bg-gradient-to-b from-[#1AD598] to-[#1AD598] border-image-[radial-gradient(50%_93.75%_at_50%_6.25%,_#A3EED6_0%,_rgba(255,255,255,0)_100%)] border-image-slice-[1] items-center flex justify-between">
